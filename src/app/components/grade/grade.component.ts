...
@Component({
  ...
  providers: [
    GradeService, GroupService, StudentService, CourseForGroupService
  ]
})
export class GradeComponent implements OnInit {
    ...
    gradeEntity(grade: any) {
      const tempGrade: any = {
        studentDegree: { id: grade.studentDegreeId || grade.studentDegree.id },
        course: { id: grade.courseId || grade.course.id },
        points: grade.points,
