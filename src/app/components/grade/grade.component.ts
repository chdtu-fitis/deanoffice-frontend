...
export class GradeComponent implements OnInit {
  ...
  makeSingleStudentAndCourseExamReport() {
    if (this.gradeTable.focusGrade)
      this.examReportService.makeSingleStudentAndCourseExamReport(this.gradeTable.focusGrade);
  }
}
