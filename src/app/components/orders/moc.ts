export const tableData = [
  {number: '15H0O-T',  type: 'Про переведення', date: new Date().toISOString(), status: 'Підписаний'},
  ...
  {number: '75E3-8', type: 'Про відрахування', date: new Date().toISOString(), status: 'Підписаний'},
  ...
  {number: '75E9-8', type: 'Про відрахування', date: new Date().toISOString(), status: 'Підписаний'},
];
